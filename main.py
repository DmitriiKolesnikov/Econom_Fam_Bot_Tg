...
buttons_keys = [
    'Среда 18 сентября 2024, 13:00',
    'Среда 18 сентября 2024, 14:00', 'Среда 18 сентября 2024, 15:00',
    'Среда 25 сентября 2024, 13:00',
    'Среда 25 сентября 2024, 14:00', 'Среда 25 сентября 2024, 15:00',
    'Среда 2 октября 2024, 13:00', 'Среда 2 октября 2024, 14:00',
    'Среда 2 октября 2024, 13:00',
    'Среда 9 октября 2024, 13:00', 'Среда 9 октября 2024, 14:00',
    'Среда 9 октября 2024, 13:00',
    'Среда 16 октября 2024, 13:00', 'Среда 16 октября 2024, 14:00',
    'Среда 16 октября 2024, 13:00',
    'Среда 23 октября 2024, 13:00', 'Среда 23 октября 2024, 14:00',
    'Среда 23 октября 2024, 13:00',
    'Среда 30 октября 2024, 13:00', 'Среда 30 октября 2024, 14:00',
    'Среда 30 октября 2024, 13:00',
    'Среда 13 ноября 2024, 13:00', 'Среда 13 ноября 2024, 14:00',
    'Среда 13 ноября 2024, 13:00',
    'Среда 20 ноября 2024, 13:00', 'Среда 20 ноября 2024, 14:00',
...
buttons_values = [
    datetime.strptime('2024-09-18', '%Y-%m-%d'), datetime.strptime('2024-09-18', '%Y-%m-%d'),
    datetime.strptime('2024-09-18', '%Y-%m-%d'), datetime.strptime('2024-09-25', '%Y-%m-%d'),
    datetime.strptime('2024-09-25', '%Y-%m-%d'), datetime.strptime('2024-09-25', '%Y-%m-%d'),
    datetime.strptime('2024-10-02', '%Y-%m-%d'), datetime.strptime('2024-10-02', '%Y-%m-%d'),
    datetime.strptime('2024-10-02', '%Y-%m-%d'), datetime.strptime('2024-10-09', '%Y-%m-%d'),
    datetime.strptime('2024-10-09', '%Y-%m-%d'), datetime.strptime('2024-10-09', '%Y-%m-%d'),
    datetime.strptime('2024-10-16', '%Y-%m-%d'), datetime.strptime('2024-10-16', '%Y-%m-%d'),
...
async def google_sheet_command(message: types.Message):
    ...
    await bot.send_photo(chat_id=message.from_user.id,
                         caption=f"👩🏼 Прием осуществляется по средам с 13.00 до 16.00 (ауд 321)\n"
