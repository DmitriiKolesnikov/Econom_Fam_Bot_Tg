...
buttons_keys = [
    ...
    'Среда 12 февраля 2025, 12:00', 'Среда 12 февраля 2025, 13:00',
    'Среда 19 февраля 2025, 12:00', 'Среда 19 февраля 2025, 13:00',
    'Среда 26 февраля 2025, 12:00', 'Среда 26 февраля 2025, 13:00',

    'Среда 5 марта 2025, 12:00', 'Среда 5 марта 2025, 13:00',
    'Среда 12 марта 2025, 12:00', 'Среда 12 марта 2025, 13:00',
    'Среда 19 марта 2025, 12:00', 'Среда 19 марта 2025, 13:00',
    'Среда 26 марта 2025, 12:00', 'Среда 26 марта 2025, 13:00',

    'Среда 2 апреля 2025, 12:00', 'Среда 2 апреля 2025, 13:00',
    'Среда 9 апреля 2025, 12:00', 'Среда 9 апреля 2025, 13:00',
    'Среда 16 апреля 2025, 12:00', 'Среда 16 апреля 2025, 13:00',
    'Среда 23 апреля 2025, 12:00', 'Среда 23 апреля 2025, 13:00',
    'Среда 30 апреля 2025, 12:00', 'Среда 30 апреля 2025, 13:00',

    'Среда 7 мая 2025, 12:00', 'Среда 7 мая 2025, 13:00',
    'Среда 14 мая 2025, 12:00', 'Среда 14 мая 2025, 13:00',
    'Среда 21 мая 2025, 12:00', 'Среда 21 мая 2025, 13:00',
    'Среда 28 мая 2025, 12:00', 'Среда 28 мая 2025, 13:00',

    'Среда 4 июня 2025, 12:00', 'Среда 4 июня 2025, 13:00',
    'Среда 11 июня 2025, 12:00', 'Среда 11 июня 2025, 13:00',
    'Среда 18 июня 2025, 12:00', 'Среда 18 июня 2025, 13:00',
    'Среда 25 июня 2025, 12:00', 'Среда 25 июня 2025, 13:00'
]
buttons_values = [
    ...
    datetime.strptime('2025-02-12', '%Y-%m-%d'), datetime.strptime('2025-02-12', '%Y-%m-%d'),
    datetime.strptime('2025-02-19', '%Y-%m-%d'), datetime.strptime('2025-02-19', '%Y-%m-%d'),
    datetime.strptime('2025-02-26', '%Y-%m-%d'), datetime.strptime('2025-02-26', '%Y-%m-%d'),
    
    datetime.strptime('2025-03-05', '%Y-%m-%d'), datetime.strptime('2025-03-05', '%Y-%m-%d'),
    datetime.strptime('2025-03-12', '%Y-%m-%d'), datetime.strptime('2025-03-12', '%Y-%m-%d'),
    datetime.strptime('2025-03-19', '%Y-%m-%d'), datetime.strptime('2025-03-19', '%Y-%m-%d'),
    datetime.strptime('2025-03-26', '%Y-%m-%d'), datetime.strptime('2025-03-26', '%Y-%m-%d'),
    
    datetime.strptime('2025-04-02', '%Y-%m-%d'), datetime.strptime('2025-04-02', '%Y-%m-%d'),
    datetime.strptime('2025-04-09', '%Y-%m-%d'), datetime.strptime('2025-04-09', '%Y-%m-%d'),
    datetime.strptime('2025-04-16', '%Y-%m-%d'), datetime.strptime('2025-04-16', '%Y-%m-%d'),
    datetime.strptime('2025-04-23', '%Y-%m-%d'), datetime.strptime('2025-04-23', '%Y-%m-%d'),
    datetime.strptime('2025-04-30', '%Y-%m-%d'), datetime.strptime('2025-04-30', '%Y-%m-%d'),
    
    datetime.strptime('2025-05-07', '%Y-%m-%d'), datetime.strptime('2025-05-07', '%Y-%m-%d'),
    datetime.strptime('2025-05-14', '%Y-%m-%d'), datetime.strptime('2025-05-14', '%Y-%m-%d'),
    datetime.strptime('2025-05-21', '%Y-%m-%d'), datetime.strptime('2025-05-21', '%Y-%m-%d'),
    datetime.strptime('2025-05-28', '%Y-%m-%d'), datetime.strptime('2025-05-28', '%Y-%m-%d'),
    
    datetime.strptime('2025-06-04', '%Y-%m-%d'), datetime.strptime('2025-06-04', '%Y-%m-%d'),
    datetime.strptime('2025-06-11', '%Y-%m-%d'), datetime.strptime('2025-06-11', '%Y-%m-%d'),
    datetime.strptime('2025-06-18', '%Y-%m-%d'), datetime.strptime('2025-06-18', '%Y-%m-%d'),
    datetime.strptime('2025-06-25', '%Y-%m-%d'), datetime.strptime('2025-06-25', '%Y-%m-%d')
]
