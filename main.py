...
buttons_keys = [
    'Среда февраля 2024, 14:00', 'Среда 14 февраля 2024, 15:00',
    ...
    'Среда 5 июня 2024, 14:00', 'Среда 5 июня 2024, 15:00',
    'Четверг 6 июня 2024, 14:00', 'Четверг 6 июня 2024, 15:00',
]
buttons_values = [
    ...
    datetime.strptime('2024-06-05', '%Y-%m-%d'), datetime.strptime('2024-06-05', '%Y-%m-%d'),
    datetime.strptime('2024-06-06', '%Y-%m-%d'), datetime.strptime('2024-06-06', '%Y-%m-%d')
]
