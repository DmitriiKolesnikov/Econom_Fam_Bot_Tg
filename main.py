...
if __name__ == '__main__':
    executor.start_polling(dp,
                           ...
                           skip_updates=True)
    bot.send_message(chat_id=1969472760,
                     text=f'Добрый день, Уважаемый(ая) Мария Резникова!  \n\n'
                          f'К настоящему моменту Ваш лимит в 2 бесплатные сессии психотерапевта исчерпан. '
                          f'Если у Вас есть желание продолжить работу на платной основе, для студентов экономического факультета МГУ действуют особые условия. '
                          f'Стоимость одной сессии в когнитивно-поведенческом подходе продолжительностью 50 минут для студентов ЭФ МГУ составляет 1,500 рублей.'
                          f'Если Вы заинтересованы в продолжении работы, можете связаться с психотерапевтом Полиной Чибисовой по следующим контактным данным в Telegram: https://t.me/Pelageya_17\n\n'
                          f'Желаем Вам отличного дня!')

    bot.send_message(chat_id=739380400,
                     text=f'Добрый день, Уважаемый(ая) Мария Резникова!  \n\n'
                          f'К настоящему моменту Ваш лимит в 2 бесплатные сессии психотерапевта исчерпан. '
                          f'Если у Вас есть желание продолжить работу на платной основе, для студентов экономического факультета МГУ действуют особые условия. '
                          f'Стоимость одной сессии в когнитивно-поведенческом подходе продолжительностью 50 минут для студентов ЭФ МГУ составляет 1,500 рублей.'
